...
a set of landmarks and all samples. `lmds` built-in support for sparse matrices.

In essence, LMDS attempts to produce the same dimensionality reduction as `cmdscale()`, but 
in a much more scaleable manner.
